...
const WINE_COUNTRY_REGIONS = [
  ["フランス", ["フランス", "シャブリ", "ボルドー", "ブルゴーニュ", "シャンパーニュ", "ローヌ", "ロワール", "アルザス", "ラングドック", "プロヴァンス", "ボジョレー", "メドック", "ソーテルヌ", "コート・ド・ボーヌ", "コート・ド・ニュイ", "ジュラ", "サヴォワ", "コルシカ"]],
  ["イタリア", ["イタリア", "ピエモンテ", "トスカーナ", "ヴェネト", "シチリア", "バローロ", "バルバレスコ", "キャンティ", "アブルッツォ", "プーリア", "ヴァルポリチェッラ", "ウンブリア", "ネッビオーロ", "サンジョヴェーゼ", "バルベーラ", "ドルチェット", "モンテプルチアーノ", "コルヴィーナ", "グレラ", "ヴェルディッキオ", "ネロダーヴォラ", "プリミティーヴォ"]],
  ["ドイツ", ["ドイツ", "モーゼル", "ラインガウ", "ファルツ", "バーデン", "ナーエ", "ラインヘッセン", "ミュラー・トゥルガウ", "シルヴァーナー", "ドルンフェルダー"]],
  ["スペイン", ["スペイン", "リオハ", "リベラ・デル・ドゥエロ", "リベラデルドゥエロ", "ラ・マンチャ", "ヘレス", "カバ", "プリオラート", "シェリー", "テンプラニーリョ", "アルバリーニョ", "ガルナッチャ", "モナストレル", "マカベオ"]],
  ["ポルトガル", ["ポルトガル", "ドウロ", "ヴィーニョ・ヴェルデ", "ポルト", "ダン", "マデイラ", "トウリガナシオナル", "バガ"]],
  ["アメリカ", ["アメリカ", "ナパ", "ソノマ", "オレゴン", "ワシントン州", "カリフォルニア", "ジンファンデル"]],
  ["チリ", ["チリ", "マイポ", "コルチャグア", "カルメネール"]],
  ["アルゼンチン", ["アルゼンチン", "メンドーサ", "マルベック"]],
  ["オーストラリア", ["オーストラリア", "バロッサ", "ハンターバレー", "マーガレットリバー"]],
  ["ニュージーランド", ["ニュージーランド", "マールボロ"]],
  ["南アフリカ", ["南アフリカ"]],
  ["オーストリア", ["オーストリア", "ヴァッハウ", "カンプタール", "グリューナー・ヴェルトリーナー"]],
  ["ハンガリー", ["ハンガリー", "トカイ", "フルミント"]],
  ["ジョージア", ["ジョージア", "カヘティ", "サペラヴィ", "ルカツィテリ"]],
  ["日本", ["日本", "山梨", "北海道"]],
];
...
function guessCategory(schema, card) {
  if (schema === "wine") {
    ...
    const hit = WINE_COUNTRY_REGIONS.find(([, keywords]) => keywords.some((k) => haystack.includes(k)));
    return hit ? hit[0] : "";
  }
  if (schema === "korean") {
