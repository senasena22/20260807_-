...
const WINE_COUNTRY_REGIONS = [
  ...
  ["イタリア", ["イタリア", "ピエモンテ", "トスカーナ", "ヴェネト", "シチリア", "バローロ", "バルバレスコ", "キャンティ", "アブルッツォ", "プーリア", "ヴァルポリチェッラ", "ウンブリア"]],
  ["ドイツ", ["ドイツ", "モーゼル", "ラインガウ", "ファルツ", "バーデン", "ナーエ", "ラインヘッセン"]],
  ["スペイン", ["スペイン", "リオハ", "リベラ・デル・ドゥエロ", "リベラデルドゥエロ", "ラ・マンチャ", "ヘレス", "カバ", "プリオラート", "シェリー"]],
  ["ポルトガル", ["ポルトガル", "ドウロ", "ヴィーニョ・ヴェルデ", "ポルト", "ダン", "マデイラ"]],
  ["アメリカ", ["アメリカ", "ナパ", "ソノマ", "オレゴン", "ワシントン州", "カリフォルニア"]],
  ["チリ", ["チリ", "マイポ", "コルチャグア"]],
  ["アルゼンチン", ["アルゼンチン", "メンドーサ"]],
  ["オーストラリア", ["オーストラリア", "バロッサ", "ハンターバレー", "マーガレットリバー"]],
  ["ニュージーランド", ["ニュージーランド", "マールボロ"]],
  ["南アフリカ", ["南アフリカ"]],
  ["オーストリア", ["オーストリア", "ヴァッハウ", "カンプタール"]],
  ["ハンガリー", ["ハンガリー", "トカイ"]],
  ["ジョージア", ["ジョージア", "カヘティ"]],
  ["日本", ["日本", "山梨", "北海道"]],
];
